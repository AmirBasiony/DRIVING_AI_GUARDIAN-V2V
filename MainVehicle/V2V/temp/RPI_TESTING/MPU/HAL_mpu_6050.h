...
#define I2C_init()   i2c_init(MPU6050_Slave_Address) 
#define I2C_start() (i2c_init(MPU6050_Slave_Address))
#define I2C_stop() (i2c_close())
#define I2C_send(x) (i2c_send_byte(x))      //(i2c_send_data(x,sizeof(uint8)))
#define I2C_get(x) (i2c_receive_byte(x))
