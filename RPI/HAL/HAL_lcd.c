...
void init_LCD()
{
    ...
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output,RS);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, RW);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, E);

//============================
// SET THE NEXT 8 PINS AS INPUT
//============================
#ifdef EIGHT_BIT_MODE
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_0);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_1);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_2);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_3);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_4);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_5);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_6);
    MCAL_GPIO_SET_Pin(LCD_CTRL, Output, GPIO_PIN_7);
